...
*/
-- Your query below:
SELECT teamID, name, yearID FROM teams WHERE LgID LIKE "AL";
...
*/
-- Your query below:
SELECT teamID, name, lgID FROM teams WHERE lgID LIKE "NL";
...
*/
-- Your query below:
SELECT playerID, yearID, HR, lgID FROM batting WHERE HR > 40 AND lgID LIKE "NL";